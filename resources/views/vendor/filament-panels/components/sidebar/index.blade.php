...
>
    ...
    <nav
        class="fi-sidebar-nav flex-grow flex flex-col gap-y-7 overflow-y-auto overflow-x-hidden px-4 py-4 bg-white ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 lg:shadow-md"
