    ...
    <x-filament-tables::container>
        ...
        >
            ...
            <div
                ...
                class="flex items-center justify-between px-4 py-3 fi-ta-header-toolbar gap-x-4 sm:px-6"
            >
            ...
            @if (($content || $hasColumnsLayout) && ($records !== null) && count($records))
                ...
                @else
                    <x-filament::grid
                        ...
                        @class([
                            'fi-ta-content-grid gap-1 p-1 sm:px-1 dedens' => $contentGrid,
                        ...
                        @foreach ($records as $record)
                            ...
                            <div
                                ...
                                @class([
                                    ...
                                    'rounded-sm shadow-sm ring-1 ring-gray-950/5 dark:bg-white/5 dark:ring-white/10' => $contentGrid,
                            ...
                            >
                                @php
                                    ...
                                    $recordContentHorizontalPaddingClasses = \Illuminate\Support\Arr::toCssClasses([
                                        ...
                                        'ps-0 deden' => $contentGrid && (! $hasItemBeforeRecordContent),
                                        'pe-2' => $contentGrid && $hasItemAfterRecordContent,
                                        'pe-0 deden' => $contentGrid && (! $hasItemAfterRecordContent),
                                    ]);
                                    ...
                                    $recordActionsClasses = \Illuminate\Support\Arr::toCssClasses([
                                        ...
                                        'ps-0 deden' => $contentGrid && (! $hasItemBeforeRecordContent),
                                        'pe-2' => $contentGrid && $hasItemAfterRecordContent,
                                        'pe-0 dedens' => $contentGrid && (! $hasItemAfterRecordContent),
                                    ]);
                                @endphp
                                ...
                                >
                                    ...
                                    <div
                                        @class([
                                            'flex w-full flex-col gap-y-3 py-0',
